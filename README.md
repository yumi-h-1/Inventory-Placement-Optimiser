...
~91k delivered order items, 2016–2018): a **ridge-regression forecaster** predicts weekly
demand, a **multinomial logistic regression (MNL)** describes how orders are routed across
the fulfilment network today, and a **linear-programming optimiser (PuLP)** prescribes where
inventory *should* be placed — evaluated under demand uncertainty with residual-bootstrap
scenarios, and served as a **FastAPI service in Docker**.
